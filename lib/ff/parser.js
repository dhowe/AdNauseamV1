...
var AdParser =  require('sdk/core/heritage').Class({
    ...
    doImport : function(ads) { 
        ...
        this.adlist = ads;
// TMP-remove
//var num=300, start = 300;//Util.rand(ads.length-num);
//console.log("Showing "+start+"-"+(start+num)+ ' of '+ ads.length + ' total');
//this.adlist = ads.slice(start, start+num);
    },
