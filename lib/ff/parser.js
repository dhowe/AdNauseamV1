...
var AdParser = require('sdk/core/heritage').Class({
        ...
        // load all scripts from these domains 
        allowScriptDomains: [ 'www.thestranger.com', 'google.com' ],
        ...
        initialize: function(comp) {
            ...
            this.count = Math.max(1, 1 + (Math.max.apply(Math, this.adlist.map(function(ad) {
                                return ad.id;
                            }))));
