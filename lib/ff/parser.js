...
/*
 WORKING HERE: need to parse a tags from inside div in findNode() *****
 
<div id="google_image_div" style="overflow:hidden; position:absolute">
    <a id="aw0" target="_blank" href="http://googleads.g.doubleclick.net/aclk?sa=L&amp;ai=BLPMyj_PhVKfyMcb_9QWqxoDIBLa_o-oGAAAAEAEgorqwCDgAWO7ryqD6AWDZArIBE3d3dy50aGVzdHJhbmdlci5jb226AQlnZnBfaW1hZ2XIAQLaARdodHRwOi8vdGhlc3RyYW5nZXIuY29tL8ACAuACAOoCGi8xMDQ3OTI2L1N0cmFuZ2VyX0hvbWVfVG9w-AKB0h6AAwGQA7AJmAPwAagDAcgDmQTgBAGgBhTYBwE&amp;num=0&amp;sig=AOD64_2GSX644SKWoV1aPaeCP2pXzPf73A&amp;client=ca-pub-0969663119487598&amp;adurl=http://www.showboxpresents.com/events/detail/270231&amp;nm=2&amp;nx=571&amp;ny=-146&amp;mb=2" onfocus="ss('aw0')" onmousedown="st('aw0')" onmouseover="ss('aw0')" onclick="ha('aw0')">
        <img src="http://pagead2.googlesyndication.com/simgad/8226285733121743793" alt="" class="img_ad" height="250" border="0" width="970">
    </a>
</div>
*/
    ...
    handleAd : function(wnd, node, type, loc, collapse, abpResult) {
        ...
        var uiMan = require("./uiman").UIManager,
            parentUrl = wnd.wrappedJSObject.document.URL,
...
Util.log('handleAnchor(): '+rNode.tagName,loc.spec);
