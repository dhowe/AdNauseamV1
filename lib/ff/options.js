...
var Options = require('sdk/core/heritage').Class({
        ...
        toJSON: function() {
            ...
            var options = {}, system = require("sdk/system");
            ...
            options.firefox = Services.appinfo.platformVersion + '/' +
              system.build+ '/' +system.platform;
              
            options.version = require("sdk/self").version; // used in settings
