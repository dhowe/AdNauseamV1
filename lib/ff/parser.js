...
var AdParser = require('sdk/core/heritage').Class({
        ...
        whitelistedScriptDomains: ['www.thestranger.com', 'www.ebay.com', 'mediatakeout.com', 'www.zam.com'],
        ...
        handleHiddenElement: function(url, selector) {
            ...
            if (!this.elemHideMap[url]) { // first hidden element for page
                ...
                if (!tab) {
                    throw new Error("parser.handleHiddenElement: no tab " + " for selector:   " + selector + "\nt\t\tON " + url);
                }
