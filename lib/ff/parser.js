...
var AdParser = require('sdk/core/heritage').Class({
        ...
        onAttach: function(tab) {
            ...
            if (this.checkVersion("36")) // update the badge
                require("./uiman").UIManager.button.badge = null;
        ...
        makeAd: function(adId, pageTitle, pageUrl, targetUrl, contentData, adTitle) {
            ...
            // update badge count
            if (this.checkVersion("36"))            
                require("./uiman").UIManager.button.badge = pageMapEntry.ads.length;
