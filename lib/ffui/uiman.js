...
var _UIManager = require('sdk/core/heritage').Class({
	...
	updateAdData : function(field, theAd) {
		...
		this.worker.port.emit("ad-updated", update);
		this.menu.port.emit("ad-updated",  update);	
	},
		...
		if (!this.tab) {
			...
			require('sdk/tabs').open({
			    ...
			    isPinned: true,
			  	...
			  	onReady : refreshIfAdVault.bind(this),
			  	
				onActivate : refreshIfAdVault.bind(this),
