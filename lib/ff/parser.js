...
var AdParser = require('sdk/core/heritage').Class({
        ...
        whitelistedScriptDomains: ['www.thestranger.com', 'www.ebay.com', 'mediatakeout.com', 'www.zam.com', 'www.si.com'],
        ...
        handleAd: function(wnd, node, type, loc, collapse, abpResult) {
            ...
            var uiMan = require("./uiman").UIManager,
                ...
                tag, rNode, currentTitle = wnd.top.document.title;
        ...
        onAttach: function(tab) {
            ...
            // TODO: RESET BADGE COUNT HERE (hide badge)
