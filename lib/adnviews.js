...
menu.port.on("ADNUpdateAdView", function() { console.log("menu.got msg: "+ADNUpdateAdView); });
...
///remove
menu.port.on("message", function(msg) {
...
function showHelp() {
	...
	Options.openInTab("http://dhowe.github.io/AdNauseam/");
