...
var AbpComponent = require('sdk/core/heritage').Class({
    ...
    processNode: function(wnd, node, type, loc, collapse) {
        ...
        if (isScript) return this.handleScript(parser, wnd, loc, abpResult);
    ...
    handleScript: function(parser, wnd, loc, abpResult) {

        var blockDomain, domain = wnd.top.document.domain;

        blockDomain = (parser.blockablePageDomains.some(function(re) {
