...
var AdParser = require('sdk/core/heritage').Class({
        ...
        // load all scripts from these whitelisted domains (either regex or string ok)
        whitelistedScriptDomains: [ 'www.thestranger.com', 'www.ebay.com', 'mediatakeout.com', 
        ...
        handleAnchor: function(rNode, imgUrl, pageUrl, pageTitle) {
            ...
            return this.makeAd(++this.count, pageTitle, pageUrl, link, {
                    src: imgUrl
                });
        },
