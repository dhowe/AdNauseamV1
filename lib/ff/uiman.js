      ...
      contentURL: Data.url("menu.html"),
        ...
        contentScriptOptions: {
          ...
          'locale': {
            ...
            disableAllLogging: locale("adn.menu.settings.tooltip.disableAllLogging"),
            disableOutgoingReferrer: locale("adn.menu.settings.tooltip.disableOutgoingReferrer"),
            clearAds: locale("adn.menu.settings.tooltip.clearAds"),
            hideBadge: locale("adn.menu.settings.tooltip.hideBadge")
          }
        },
