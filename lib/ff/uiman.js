        ...
        openLog: function() {
            ...
            function sendLogData(tab) {
                ...
                if (tab && tab.url === Data.url("log.html")) {
                    ...
                    this.logJSON = require("./logger.js").Logger.logJSON;
                    // console.log("openLog: ", this.logJSON);
                    this.logHTMLWorker && this.logHTMLWorker.port.emit('show-log', this.logJSON);
                }
            }
        },
        
        updateLogPageFromLogger: function() {
