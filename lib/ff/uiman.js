...
const {
    Cc, Ci, Cu
} = require("chrome"); //.Cc, Ci = require("chrome").Ci, Cu = require("chrome").Cu;
const {
    OS
        ...
        registerEventHandlers: function() {
            ...
            this.menu.port.on("show-log", function() {
                    ...
                    if (Options.get('disableLogs') || !Logger.ostream) {
                        ...
                        Logger.notify("No log available (AdNauseam is disabled or" + " the 'disableLogs' preference is checked)"); // TODO: localize
                    } else {
