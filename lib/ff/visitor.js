const verbose = 0, pollQueueInterval = 5000;
...
var AdVisitor = require('sdk/core/heritage').Class({
	...
	currentAd : null, 
	lastVisitTs : 0,
	lastWriteTs : 0, // move to parser.saveAdlookup
	maxAttempts : 3,
	pageWorker : null,
	allowJsOnPage : false,
	visitTimeoutMs : 5000,
    ...
    pollQueue : function() {
		...
		if (!this.component.initd || elapsed < this.visitTimeoutMs) 
