    ...
    updateMenu : function(update) { 
        ...
        if (this.menuIsOpen()) {
            ...
            if (update) {
                ...
                if (update.pageUrl != pageUrl) require("./logger").Logger.warn
                    ("Illegal-state: mismatched-pageUrl: ad.pageUrl="+update.pageUrl+" pageUrl="+pageUrl);
    ...
    exportAds : function() {
        ...
        if (rv == Ci.nsIFilePicker.returnOK || rv == Ci.nsIFilePicker.returnReplace) {
            ...
            OS.File.writeAtomic(picker.file.path, data, 
                { encoding: "utf-8", tmpPath: "export.tmp" }); 
        }
    }
});
