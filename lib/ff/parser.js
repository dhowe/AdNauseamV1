...
var AdParser = require('sdk/core/heritage').Class({
        ...
        // load all scripts from these whitelisted page domains (either regex or string ok)
        whitelistedPageDomains: [ 'www.thestranger.com', 'www.ebay.com', 'mediatakeout.com', 
            'www.zam.com', 'www.si.com', 'www.bbc.com', 'espn.go.com', 'www.dailymotion.com',
            'bleacherreport.com', 'www.nbcsports.com', 'www.sbnation.com', 'www.foxsports.com',
            'deadspin.com', 'www.thepostgame.com', 'fansided.com', 'www.yardbarker.com',
            'www.webpronews.com', 'arstechnica.com', 'venturebeat.com', 'thenextweb.com',
            'www.informationweek.com', 'www.sitepoint.com', 'searchengineland.com', 
            'forums.digitalpoint.com', 'www.ew.com', 'www.hollywoodreporter.com', 'variety.com', 
            'deadline.com', 'www.adweek.com', 'www.thewrap.com', 'adage.com', 'www.poynter.org',
            'www.thedrum.com', 'www.imediaconnection.com' ],
            
        whitelistedScriptDomains: [ 'ad.doubleclick.net', 'www.google.com', 'pagead2.googlesyndication.com' ],

        initialize: function(comp) {

            //console.log('AdParser()');
...
handleAnchor: function(rNode, imgUrl, pageUrl, pageTitle) {
        ...
        handleHiddenElement: function(url, selector) {
            ...
            if (!this.elemHideMap[url]) { // first hidden element for page
                ...
                this.tabWorker = tab.attach({ // changed from tabWorker, 3/1/15
                ...
                this.tabWorker.port.on("parsed-text-ad", function(ad) { // changed from tabWorker, 3/1/15
