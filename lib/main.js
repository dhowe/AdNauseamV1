...
exports.main = function(opts, callbacks) {
	
	if (1) Logger.log("Main::main() -> "+opts.loadReason);	
	...
	if (opts.loadReason == "install" || opts.loadReason == "downgrade") {
    ...
    else if (opts.loadReason == "enable") {
    	
    	Component && (Component.restart(opts.loadReason));
    }    
