...
function findTab(url) { // Note: returns the first matching tab only
...
function log() {
    ...
    if (typeof require == 'undefined' || !require("./options").production)
...
function error() { // log errors even in production (?)
