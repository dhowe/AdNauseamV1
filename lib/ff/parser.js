...
//Logger.log("pre-find: "+loc.spec+' :: '+type());//+' '+newNode._width+'x'+newNode._height);
        ...
        if (!rNode.parentNode)
            Logger.warn("no parent-node for rNode!!!"); // TODO: is this needed above?
