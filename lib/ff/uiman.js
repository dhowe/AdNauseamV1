...
var UIManager = require('sdk/core/heritage').Class({
        ...
        registerEventHandlers: function() {
            ...
            this.menu.port.on("show-log", function() {
                    ...
                    require("./logger").Logger.log('UI->show-log');

                    if (Options.get('disableLogs') || !Logger.ostream) {

                        require("./logger").Logger.notify("No log available (AdNauseam is disabled or" + " the 'disableLogs' preference is checked)"); // TODO: localize
                    } 
                    else {
